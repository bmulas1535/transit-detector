...
navbar = dbc.NavbarSimple(
    ...
    children=[
        ...
        dbc.NavItem(dcc.Link('Help', href='/fitshelp', className='nav-link')), 
    ],
    sticky='top',
    color='dark', 
    light=False, 
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Brandon Mulas', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:bsmulas1535@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/bmulas1535/exoplanet-hunting'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/brandon-mulas-801915157/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/Brandon54911946'), 
                ], 
                className='lead'
            )
        )
